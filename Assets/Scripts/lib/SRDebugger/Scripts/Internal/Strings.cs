...
namespace SRDebugger.Internal
{
	public class SRDebugStrings
	{
		...
		public readonly string SettingsSupportUrl = "http://forum.unity3d.com/threads/srdebugger-debug-and-tweak-your-game-while-on-device-released.296403/";

		public readonly string SettingsEnabledTabsDescription =
			"Uncheck any tabs that you do not wish to be available in the SRDebugger panel.";
