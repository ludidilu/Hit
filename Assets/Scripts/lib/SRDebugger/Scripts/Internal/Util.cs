		...
		public static ICollection<OptionDefinition> ScanForOptions(object obj)
		{
			...
			foreach (var memberInfo in members) {
				...
				if (memberInfo is PropertyInfo) {
					...
					options.Add(new OptionDefinition(name, category, sortPriority, new SRF.Helpers.PropertyReference(obj, propertyInfo)));
					...
					options.Add(new OptionDefinition(name, category, sortPriority, new SRF.Helpers.MethodReference(obj, methodInfo)));
