...
namespace SRDebugger.Services
{
	...
	public interface IDebugService
	{
		...
		/// </summary>
		/// <param name="requireEntryCode">If true and entry code is enabled in settings, the user will be prompted for a passcode before opening the panel.</param>
		...
		/// <param name="takeScreenshot">Take a screenshot before opening the report sheet (otherwise a screenshot will be taken as the report is sent)</param>
